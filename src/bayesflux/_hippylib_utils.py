...
def worker_generates_reduced_hippylib_training_data(
...
def single_process_worker_generates_reduced_hippylib_training_data(
    ...
    return worker_generates_reduced_hippylib_training_data(
        task_id,
...
def __single_process_worker_generator(model_name, N_samples, N_processes, random_seed_offset, **kwargs):
    ...
    return partial(
        single_process_worker_generates_reduced_hippylib_training_data,
        model_name=model_name,
        N_samples=N_samples,
